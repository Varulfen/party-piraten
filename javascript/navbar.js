class Navbar extends HTMLElement {
    connectedCallback() {
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark" aria-label="Fourth navbar example">
                <div class="container-fluid"><a class="navbar-brand" href="../html/index.html">Knight Duck Club</a>
                ...
                <div class="collapse navbar-collapse" id="navbarsExample04">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="../html/index.html">Main Version</a></li>
                        <li class="nav-item"><a class="nav-link disabled" href="../html/alternative.html" aria-disabled="true">Alternative Version</a></li>
                        <li class="nav-item"><a class="nav-link active" href="../html/statistics.html">Statistics</a></li>
                    </ul>
